...
class ResendActivationCodeView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('users:resend_activation_code')
...
class RestorePasswordView(GuestOnlyView, FormView):
    ...
    def form_valid(self, form):
        ...
        return redirect('users:restore_password_done')


class ChangeProfileView(LoginRequiredMixin, FormView):
    template_name = 'users/profile/change_profile.html'
...
class ChangeEmailView(LoginRequiredMixin, FormView):
    template_name = 'users/profile/change_email.html'
...
class RemindUsernameView(GuestOnlyView, FormView):
    template_name = 'users/remind_username.html'
    ...
    def form_valid(self, form):
        ...
        return redirect('users:remind_username')
